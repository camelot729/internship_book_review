...
class ReviewCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create review_comment" do
    assert_difference('ReviewComment.count') do
      post review_comments_url, params: { review_comment: { body: @review_comment.body, book_id: @review_comment.book_id, title: @review_comment.title } }
    end
  ...
  test "should update review_comment" do
    patch review_comment_url(@review_comment), params: { review_comment: { body: @review_comment.body, book_id: @review_comment.book_id, title: @review_comment.title } }
